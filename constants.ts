...
// Image Assets - Updated paths for Vercel
export const IMAGES = {
...
export const FAQS = [
  ...
  },
  {
    ...
    answer: "Towing costs vary based on distance, vehicle type, and situation (e.g., accident vs. breakdown). Call us at 0469 747 214 for an immediate, fixed-price quote."
  },
  {
...
export const REVIEWS = [
  ...
  {
    name: "Mike Thompson",
    text: "Used SG Express to move a project car. Great price and very professional handling of the vehicle. The truck was clean and modern.",
    rating: 5,
